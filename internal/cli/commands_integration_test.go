...
func TestIntegrationCamelVsPascal(t *testing.T) {
	...
	err := RunCamel(false, false, false, false, nil, nil, filePath)
	if err != nil {
	...
	err = RunPascal(false, false, false, false, nil, nil, filePath2)
	if err != nil {
...
func TestIntegrationDotDefault(t *testing.T) {
	...
	err := RunDot("", false, false, false, false, nil, nil, filePath)
	if err != nil {
...
func TestIntegrationTrim(t *testing.T) {
	...
	// Call RunTrim
	err := RunTrim("_", false, false, false, false, nil, nil, filePath)
	if err != nil {
